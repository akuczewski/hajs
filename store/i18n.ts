...
export const translations: Translations = {
  en: {
    ...
    dashboard: {
      ...
      goalsThisMonth: "Goals this month",
      noGoals: "No savings goals yet.",
      buildNwChart: "Update balances regularly to build your Net Worth chart",
    ...
    cashflow: {
      ...
      calculatedAverage: "3-month avg",
      baseAmount: "Base amount",
      last3MonthsAvg: "avg of last 3 months",
      paid: "PAID",
      of: "of",
  ...
  pl: {
    ...
    dashboard: {
      ...
      goalsThisMonth: "Cele w tym miesiącu",
      noGoals: "Brak celów oszczędnościowych.",
      buildNwChart: "Aktualizuj salda regularnie, aby budować wykres Wartości Netto",
    ...
    cashflow: {
      ...
      calculatedAverage: "Średnia 3-miesięczna",
      baseAmount: "Kwota bazowa",
      last3MonthsAvg: "śr. z ostatnich 3 mies.",
      paid: "OPŁACONE",
      of: "z",
