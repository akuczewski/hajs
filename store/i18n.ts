...
export const translations: Translations = {
  en: {
    ...
    settings: {
      ...
      premiumTitle: "Hajs Premium",
      premiumDesc: "Unlock backup, widgets, FIRE calculator and more.",
    ...
    onboarding: {
      slide1Title: "Every złoty has a job",
      slide1Desc: "Zero-based budgeting: assign every income to a category before you spend it.",
      slide2Title: "Net Worth at a glance",
      slide2Desc: "See all your accounts, assets, crypto and goals in one place.",
      slide3Title: "Plan months ahead",
      slide3Desc: "Travel in time — check past budgets and plan up to 3 months into the future.",
      slide4Title: "Goals with a deadline",
      slide4Desc: "Set a target, pick a date and the app tells you how much to save each month.",
      getStarted: "Get started for free",
      next: "Next",
    },
    paywall: {
      title: "Hajs Premium",
      subtitle: "Back up your data. Never lose your budget.",
      feature1: "iCloud / Google Drive backup",
      feature2: "Push payment reminders",
      feature3: "iOS Home Screen Widgets",
      feature4: "FIRE Calculator",
      feature5: "Debt Snowball / Avalanche",
      feature6: "CSV & PDF Export",
      monthlyLabel: "Monthly",
      monthlyPrice: "11 PLN / month",
      annualLabel: "Annual",
      annualPrice: "99 PLN / year",
      annualSaving: "Save 45%",
      lifetimeLabel: "Lifetime",
      lifetimePrice: "199 PLN once",
  ...
  pl: {
    ...
    settings: {
      ...
      premiumTitle: "Hajs Premium",
      premiumDesc: "Odblokuj backup, widgety, kalkulator FIRE i wiele więcej.",
      premiumBadge: "PREMIUM",
    ...
    onboarding: {
      slide1Title: "Każda złotówka ma swoje miejsce",
      slide1Desc: "Zero-based budgeting: przypisz każdy przychód do kategorii zanim wydasz.",
      slide2Title: "Majątek na jednym ekranie",
      slide2Desc: "Wszystkie konta, aktywa, kryptowaluty i cele w jednym miejscu.",
      slide3Title: "Planuj miesiące naprzód",
      slide3Desc: "Wehikuł czasu — sprawdź przeszłe budżety i planuj do 3 miesięcy w przód.",
      slide4Title: "Cele z terminem",
      slide4Desc: "Podaj cel i datę, a apka powie ile odkładać co miesiąc.",
      getStarted: "Zacznij za darmo",
      next: "Dalej",
    },
    paywall: {
      title: "Hajs Premium",
      subtitle: "Zabezpiecz dane. Nigdy nie strać budżetu.",
      feature1: "Backup iCloud / Google Drive",
      feature2: "Powiadomienia o płatnościach",
      feature3: "Widgety na ekranie głównym iOS",
      feature4: "Kalkulator FIRE",
      feature5: "Spłata długów Snowball / Avalanche",
      feature6: "Eksport CSV i PDF",
      monthlyLabel: "Miesięcznie",
      monthlyPrice: "11 PLN / miesiąc",
      annualLabel: "Rocznie",
      annualPrice: "99 PLN / rok",
      annualSaving: "Oszczędzasz 45%",
      lifetimeLabel: "Dożywotni",
      lifetimePrice: "199 PLN jednorazowo",
      lifetimeBadge: "Najlepsza wartość",
      restore: "Przywróć zakupy",
      terms: "Warunki i Prywatność",
      loading: "Ładowanie ofert…",
      purchasing: "Przetwarzanie…",
      errorTitle: "Błąd zakupu",
      close: "Może później",
    },
  }
};
