  ...
  return (
    <Modal visible={visible} transparent animationType="slide">
      <View className="flex-1 justify-end bg-black/60">
        <View className="bg-[#1C1F22] rounded-t-3xl p-6 h-[50%] border-t border-[#272A2E]">
          ...
          {currentAmount !== defaultAmount && (
            <TouchableOpacity onPress={handleReset} className="py-4 items-center border border-[#3F3F46] rounded-xl">
